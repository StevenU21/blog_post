    ...
    <div class="card bg-secondary shadow">
        <div class="card-header bg-white border-0">
            <div class="row align-items-center">
                <div class="col-8">
                    <h3 class="mb-0"><i class="fas fa-edit"></i> Actualizar Producto</h3>
                </div>
                <div class="col-4 text-right">
                    <a href="{{ route('products.index') }}" class="btn btn-sm btn-primary" wire:navigate>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="input-name" wire:model.defer="product.name"
                                    class="form-control form-control-alternative" placeholder="Nombre" value="{{ old('name', $product->name) }}">
                                @error('product.name')
